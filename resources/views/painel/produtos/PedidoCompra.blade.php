	...
	<div class="box-body">
		...
		<table id="example1" class="table table-bordered table-striped dataTable cell-border" role="grid" aria-describedby="example1_info">
			...
			<tbody>
				...
				@foreach($p->produto()->get(['id','Codigo','Produto', 'Inativo', 'LkSetor', 'Fabricante', 'PrecoCusto', 'PrecoVenda', 'DataInc']) as $dadosProd)
				@if($dadosProd->Inativo == 0)
