...
<ol class="breadcrumb">
	<li>
		<a href="#">
			<i class="fa fa-dashboard"></i> Faturamento</a>
	</li>
	<li>
		<a href="#">Relação</a>
	</li>
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">Faturamentos Importados</h3>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
		<a href="{{url('/faturamentos/create')}}" class="btn btn-primary btn-lg active btn-add">
		...
		<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
			...
			<tbody>
				...
				<tr role="row" class="odd" id="{{$despesa->id}}">
					...
					<td>
						<a href="{{ route ( 'faturamentos.edit', $despesa->id ) }}" class="actions edit">
							<span class="btn btn-primary btn-xs glyphicon glyphicon-pencil"></span>
						</a>

						{!! Form::open(['method' => 'DELETE', 'route'=>['faturamentos.destroy', $despesa->id], 'style'=> 'display:inline']) !!}
